...
public class BSTTest {
    ...
    public void setUp() {
        ...
        List<Integer> nums2 = IntStream.range(0, 50).boxed().collect(Collectors.toList());
        Collections.shuffle(nums);

        List<Integer> nums3 = IntStream.range(0, 20).boxed().collect(Collectors.toList());
        Collections.shuffle(nums);
        ...
        bst2 = BST.EBST;
        for (int i : nums2) bst2 = bst2.BSTinsert(i);

        bst3 = BST.EBST;
        for (int i : nums3) bst3 = bst3.BSTinsert(i);
    }
    ...
    public void BSTLeaf () throws EmptyBSTE {
        ...
        bst2 = BST.BSTLeaf(15);
        assertEquals(15,bst2.BSTData());
        assertTrue(bst2.BSTLeft().isEmpty());
        assertTrue(bst2.BSTRight().isEmpty());
        assertEquals(1, bst2.BSTHeight());
        ...
        bst3 = BST.BSTLeaf(0);
        assertEquals(0,bst3.BSTData());
        assertTrue(bst3.BSTLeft().isEmpty());
        assertTrue(bst3.BSTRight().isEmpty());
        assertEquals(1, bst3.BSTHeight());
        assertFalse(bst3.isEmpty());
        Iterator<Integer> iter3 = bst3.iterator();
        assertTrue(iter2.hasNext());
    ...
    public void BSTfind() {
        ...
        bst2 = bst2.BSTinsert(100);
        bst2 = bst2.BSTinsert(10);
        bst2 = bst2.BSTinsert(0);
        bst2 = bst2.BSTinsert(25);
        assertFalse(bst2.BSTfind(-10));
        assertTrue(bst2.BSTfind(0));
        assertTrue(bst2.BSTfind(10));
        assertTrue(bst2.BSTfind(25));

        assertFalse(bst3.BSTfind(1000));
        assertFalse(bst3.BSTfind(100));
        assertFalse(bst3.BSTfind(-100));
        assertFalse(bst3.BSTfind(50));
        assertTrue(bst3.BSTfind(0));
        assertFalse(bst3.BSTfind(60));
    }
    ...
    public void BSTinsert() {
        ...
        Iterator<Integer> iter2 = bst2.iterator();
        for (int i=0; i<50; i++) assertEquals(i,(int)iter2.next());

        Iterator<Integer> iter3 = bst3.iterator();
        for (int i=0; i<20; i++) assertEquals(i,(int)iter3.next());
    }
    ...
    public void BSTdelete() throws EmptyBSTE {
        ...
        int two = bst2.BSTData();
        BST smalleBST = bst2.BSTdelete(two);
        assertFalse(smalleBST.BSTfind(two));
        int lefMost = bst2.BSTRight().BSTdeleteLeftMostLeaf().getFirst();
        assertEquals(lefMost,(int)smalleBST.BSTData());

        int three = bst3.BSTData();
        BST smallBST = bst3.BSTdelete(three);
        assertFalse(smallBST.BSTfind(three));
        int leMost = bst3.BSTRight().BSTdeleteLeftMostLeaf().getFirst();
        assertEquals(leMost,(int)smallBST.BSTData());
    ...
    public void BSTdeleteLeftMostLeaf() throws EmptyBSTE {
        ...
        bst2 = bst2.BSTinsert(-345);
        assertTrue(bst2.BSTfind(-345));
        Pair<Integer,BST> intBST = bst2.BSTdeleteLeftMostLeaf();
        assertEquals(-345,(int)intBST.getFirst());
        assertFalse(intBST.getSecond().BSTfind(-345));

        bst3 = bst3.BSTinsert(-35);
        bst3.BSTinsert(-25);
        assertTrue(bst3.BSTfind(-35));
        Pair<Integer,BST> intBST3 = bst3.BSTdeleteLeftMostLeaf();
        assertEquals(-25,(int)intBST3.getFirst());
        assertTrue(intBST3.getSecond().BSTfind(-35));
    }
