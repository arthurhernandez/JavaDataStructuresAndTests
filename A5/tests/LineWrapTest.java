...
<<<<<<< HEAD
        ...
        String s4 = LineWrap.runGreedy(s, 15);
        String s5 = LineWrap.runDP(s, 15);
        String s6 = LineWrap.dpBU(s, 15);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(15), s4, s5, s6);

        String s7 = LineWrap.runGreedy(s, 5);
        String s8 = LineWrap.runDP(s, 5);
        String s9 = LineWrap.dpBU(s, 5);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(5), s7, s8, s9);

        String s10 = LineWrap.runGreedy(s, 1);
        String s11 = LineWrap.runDP(s, 1);
        String s12 = LineWrap.dpBU(s, 1);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(1), s10, s11, s12);
=======
       // String s3 = LineWrap.dpBU(s, 17);
    //    System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(17), s1, s2, s3);
...
*/
    ...
    @Test
    public void test14() throws NoSuchElementE {
        String s = "AA BB CC DDDDD";
        String s1 = LineWrap.runGreedy(s, 15);
        String s2 = LineWrap.runGreedy(s, 14);
        String s3 = LineWrap.runGreedy(s, 12);
        String s4 = LineWrap.runGreedy(s, 11);
        String s5 = LineWrap.runGreedy(s, 10);
        String s6 = LineWrap.runGreedy(s, 9);
        String s7 = LineWrap.runGreedy(s, 8);
        String s8 = LineWrap.runGreedy(s, 7);
        String s9 = LineWrap.runGreedy(s, 6);
        String s10 = LineWrap.runGreedy(s, 2);
        String s11 = LineWrap.runGreedy(s, 1);
        String s12 = LineWrap.runGreedy(s, 0);

        String s13 = LineWrap.runDP(s, 15);
        String s14 = LineWrap.runDP(s, 14);
        String s15 = LineWrap.runDP(s, 13);
        String s16 = LineWrap.runDP(s, 12);
        String s17 = LineWrap.runDP(s, 11);
        String s18 = LineWrap.runDP(s, 10);
        String s19 = LineWrap.runDP(s, 9);
        String s20 = LineWrap.runDP(s, 8);
        String s21 = LineWrap.runDP(s, 1);
        String s22 = LineWrap.runDP(s, 0);
<<<<<<< HEAD

=======
/*
>>>>>>> 599a5a178537c8a9585b4a63a018eb0ae1b64d65
        String s23 = LineWrap.dpBU(s, 15);
        String s24 = LineWrap.dpBU(s, 14);
        String s25 = LineWrap.dpBU(s, 13);
        String s26 = LineWrap.dpBU(s, 10);
        String s27 = LineWrap.dpBU(s, 5);
        String s28 = LineWrap.dpBU(s, 4);
        String s29 = LineWrap.dpBU(s, 3);
        String s30 = LineWrap.dpBU(s, 2);
        String s31 = LineWrap.dpBU(s, 1);
        String s32 = LineWrap.dpBU(s, 0);
...
>>>>>>> 599a5a178537c8a9585b4a63a018eb0ae1b64d65
    ...
    @Test
    public void test15() throws NoSuchElementE {
        String s22 = "AA BB CC DD EEE F GGGGGGGGGGG GGGGGGGG HHHHHHH";
        String s1 = LineWrap.runGreedy(s22, 0);
        String s2 = LineWrap.runDP(s22, 0);
<<<<<<< HEAD
        String s3 = LineWrap.dpBU(s22, 0);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(0), s1, s2, s3);
    }

    @Test
    public void test16() throws NoSuchElementE {
        String s = "Sunset is the time of day when our sky meets the outer space solar winds. There are blue, pink, and purple swirls, spinning and twisting, like clouds of balloons caught in a whirlwind. The sun moves slowly to hide behind the line of horizon, while the moon races to take its place in prominence atop the night sky. People slow to a crawl, entranced, fully forgetting the deeds that must still be done. There is a coolness, a calmness, when the sun does set.";
        String s1 = LineWrap.runGreedy(s, 20);
        String s2 = LineWrap.runDP(s, 20);
        String s3 = LineWrap.dpBU(s, 20);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(20), s1, s2, s3);
/*
Expected output:
...
and purple swirls,
spinning and
twisting, like clouds
of balloons caught in
a whirlwind. The sun
moves slowly to hide
behind the line of
horizon, while the
moon races to take its
place in prominence
atop the night
sky. People slow to a
crawl, entranced, fully
forgetting the deeds
that must still be done.
There is a coolness, a
calmness, when the sun
does set.
...
*/
    ...
    @Test
    public void test17() throws NoSuchElementE {
        String s = "It was July 21, 1969, and Neil Armstrong awoke with a start. It was the day he would become the first human being to ever walk on the moon. The journey had begun several days earlier, when on July 16th, the Apollo 11 launched from Earth headed into outer space. On board with Neil Armstrong were Michael Collins and Buzz Aldrin. The crew landed on the moon in the Sea of Tranquility a day before the actual walk. Upon Neil’s first step onto the moon’s surface, he declared, “That’s one small step for man, one giant leap for mankind.” It sure was!";
        String s1 = LineWrap.runGreedy(s, 100);
        String s2 = LineWrap.runDP(s, 100);
        String s3 = LineWrap.dpBU(s, 100);
        System.out.printf("%s%n%s%n%n%s%n%n%s%n%n%n", makeLine(100), s1, s2, s3);
    }
...
>>>>>>> 599a5a178537c8a9585b4a63a018eb0ae1b64d65
    @Test
    public void test18() throws NoSuchElementE {
        String s = "AAA BB CC DDDDD EEEEEE EE FF G HHHHH";
        String s1 = LineWrap.runGreedy(s, 10);
        String s2 = LineWrap.runDP(s, 10);
<<<<<<< HEAD
        String s3 = LineWrap.dpBU(s, 10);
        assertEquals("AAA BB CC DDDDD EEEEEE EE FF G HHHHH", s1);
        assertEquals("AAA BB CC DDDDD EEEEEE EE FF G HHHHH", s2);
        assertEquals("AAA BB CC DDDDD EEEEEE EE FF G HHHHH", s3);
=======
      //  String s3 = LineWrap.dpBU(s, 10);
        assertEquals("AAA BB CC DDDDD EEEEEE EE FF G HHHHH", s1);
        assertEquals("AAA BB CC DDDDD EEEEEE EE FF G HHHHH", s2);
